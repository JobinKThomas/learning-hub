...
import { BookOpen, LogIn, UserPlus, LogOut, ExternalLink, User } from 'lucide-react';
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <Link to="/" className="flex items-center space-x-2 text-indigo-600 hover:text-indigo-700 transition">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-indigo-600 font-semibold tracking-wide uppercase">Phase 0 Foundation</span>
            </div>
          </Link>
